  ...
  pirate: {
    ...
    model: "/models/pirate.glb",
     cannons: {
      ...
      left:  { damage: 30, fireRate: 2500,  quantity: 3, speed: 0.20 },
      right: { damage: 30, fireRate: 2500,  quantity: 3, speed: 0.20 },
    }
  },
  fragate: {
    health: 800,
    ...
    model: "/models/fragate.glb",
     cannons: {
      front: { damage: 50, fireRate: 1000, quantity: 1, speed: 0.15 },
      left:  { damage: 30, fireRate: 2500,  quantity: 5, speed: 0.20 },
      right: { damage: 30, fireRate: 2500,  quantity: 5, speed: 0.20 },
    }
  }
}